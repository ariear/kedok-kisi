...
const MainContent = () => {
    return (
        <div className="text-white w-max text-center mx-auto font-inter relative z-10 sm:px-0 px-4">
            ...
            <p className="xl:w-[800px] lg:w-[750px] md:w-[500px] sm:w-[500px] w-[80vw] mx-auto text-sm sm:text-base lg:text-lg mb-7">Di website ini anda bisa mengakses kisi-kisi PAS yang ada di SMK Troublemaker, semoga dengan adanya website ini temen-temen lebih giat lagi belajarnya!!</p>
